...
class NewListViewUnitTest(unittest.TestCase):
    ...
    def test_redirects_to_form_returned_object_if_form_not_valid(self,
...
class ListViewTest(TestCase):
    ...
    def test_for_invalid_input_renders_home_tempate(self):
    ...
    def test_for_invalid_input_reders_list_template(self):
    ...
    def test_duplicate_item_validation_errors_end_up_on_lists_pages(self):
